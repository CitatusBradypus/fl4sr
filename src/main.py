...
for nid in range(1, 8+1):
    for wid in range(0, 4):
        ...
        '--pathActor=/home/users/jpikman/catkin_ws/src/fl4sr/src/data/FLDDPG-ms-{}/weights/actor-final-4.pkl'.format(nid),
        '--pathCritic=/home/users/jpikman/catkin_ws/src/fl4sr/src/data/FLDDPG-ms-{}/weights/critic-final-4.pkl'.format(nid)]]

#COMMAND_LIST = 2 * COMMAND_LIST
